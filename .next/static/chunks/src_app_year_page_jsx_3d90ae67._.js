...
"[project]/src/app/year/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function YearlyGraph() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "YearlyGraph.useEffect": ()=>{
            const fetchYearlyData = {
                "YearlyGraph.useEffect.fetchYearlyData": async ()=>{
                    const res = await fetch('/api/expense/yearly');
                    const json = await res.json();
                    if (res.ok) setData(json.data);
                }
            }["YearlyGraph.useEffect.fetchYearlyData"];
            fetchYearlyData();
        }
    }["YearlyGraph.useEffect"], []);
...
_s(YearlyGraph, "IEMTtLVFIuToo7X/raQbJAxzNQU=");
_c = YearlyGraph;
var _c;
__turbopack_context__.k.register(_c, "YearlyGraph");
...
//# sourceMappingURL=src_app_year_page_jsx_3d90ae67._.js.map