...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        try {
            ...
            if (!res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(data.message || data.error || 'Signup failed');
                return;
            }
            // Send OTP
            ...
            if (otpRes.ok) {
                ...
                setStep(2);
            } else __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Failed to send OTP');
        } catch  {
    ...
    const handleVerify = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success('Account verified! Please log in.');
            router.push('/login');
        } catch  {
